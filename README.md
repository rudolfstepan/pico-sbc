...
| [Scientific Calculator](firmware/scientific-calculator/README.md) | Wissenschaftlicher Rechner, Programmer-, Format- und Graphmodus | `lafvin_scientific_calculator` |
