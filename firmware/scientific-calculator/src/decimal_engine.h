...
#define DECIMAL_ENGINE_MAX_DIGITS 128u
#define DECIMAL_ENGINE_DEFAULT_DIGITS 80u
#define DECIMAL_ENGINE_TEXT_CAPACITY 160u
#define DECIMAL_ENGINE_PACKED_CAPACITY 68u
